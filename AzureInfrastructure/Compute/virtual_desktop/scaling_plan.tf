...
#     off_peak_load_balancing_algorithm    = var.resource_settings.scaling_plan.schedule.off_peak.load_balancer_algorithm
...
#     ramp_up_load_balancing_algorithm     = var.resource_settings.scaling_plan.schedule.ramp_up.load_balancing_algorithm
#     ramp_up_minimum_hosts_percent        = var.resource_settings.scaling_plan.schedule.ramp_up.minimum_hosts_percent
#     peak_start_time                      = var.resource_settings.scaling_plan.schedule.peak.start_time
#     peak_load_balancing_algorithm        = var.resource_settings.scaling_plan.schedule.peak.load_balancing_algorithm
...
#     ramp_down_wait_time_minutes          = var.resource_settings.scaling_plan.schedule.ramp_down.wait_time_minutes
#     ramp_down_capacity_threshold_percent = var.resource_settings.scaling_plan.schedule.ramp_down.capacity_threshold_percent
#     ramp_down_load_balancing_algorithm   = var.resource_settings.scaling_plan.schedule.ramp_down.load_balancing_algorithm
#     ramp_down_notification_message       = var.resource_settings.scaling_plan.schedule.ramp_down.notification_message
#     ramp_down_minimum_hosts_percent      = var.resource_settings.scaling_plan.schedule.ramp_down.minimum_hosts_percent
