resource "azurerm_virtual_network_peering" "to-from-this" {
  name                      = "${var.resource_settings.local_network.name}-${var.resource_settings.remote_network.name}-peering"
...
resource "azurerm_virtual_network_peering" "from-to-this" {
  name                      = "${var.resource_settings.remote_network.name}-${var.resource_settings.local_network.name}-peering"
